...
(function(window) {
    ...
    window.noise.seed = function(seed) {
      if(seed > 0 && seed < 1) {
        // Scale the seed out
        seed *= 65536;
      }
    ...
    // 2D simplex noise
    window.noise.simplex2 = function(xin, yin) {
    ...
    // 3D simplex noise
    window.noise.simplex3 = function(xin, yin, zin) {
    ...
    // 2D Perlin Noise
    window.noise.perlin2 = function(x, y) {
    ...
    // 3D Perlin Noise
    window.noise.perlin3 = function(x, y, z) {
      // Find unit grid cell containing point
